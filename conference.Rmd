...
The deadline for submission is on **30^th^ October 2020**. 
Please find more information and the submission form for this year's conference **[here](https://bit.ly/3bmNGEw)**.

We are super happy to announce that **Dr Mariona Lozano Riera** ([twitter](https://twitter.com/marionleitz)) and **Dr José Manuel Aburto** ([twitter](https://twitter.com/jm_aburto)) will be joining us in 2021 as keynote lecturers. The workshop will be organized by our fellow PhD collegue **Ilya Kashnitsky** ([twitter](https://twitter.com/ikashnitsky)).
